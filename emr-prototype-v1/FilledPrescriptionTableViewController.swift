//
//  FilledPrescriptionTableViewController.swift
//  emr-prototype-v1
//
...
class FilledPrescriptionTableViewController: PFQueryTableViewController {
    ...
    override func queryForTable() -> PFQuery {
        ...
        query.whereKey("prescriptionFilled", equalTo: true)
